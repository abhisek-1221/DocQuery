...
const ChatSideBar = (props: Props) => {
  return (
    <div className='flex flex-col h-full p-4 text-gray-200 bg-transparent'>
      <Link href='/'>
        <Button className='w-full border-dashed border-yellow-300 border'>
      ...
      <div className='mt-4'>
        <Link href='/'>
          <Button className='w-full bg-orange-700 hover:border hover:border-dashed'>Back to Home</Button>
        </Link>
      </div>
    </div>
  )

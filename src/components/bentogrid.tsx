...
export function FeaturesSectionDemo() {
  const features = [
    {
      title: "Manage Products effectively",
      description:
        "Track and manage your products with ease using our intuitive interface of our CMS",
      skeleton: <SkeletonOne />,
      className:
        "col-span-1 lg:col-span-4 border-b lg:border-r border-neutral-800",
    },
    {
      title: "Converse analytics with AI",
      description:
        "Make realtime dashboards effortlessly using our advanced AI technology.",
    ...
    },
    {
      ...
      description:
        "Data is replicated across 8+ regions worldwide to provide lowest latency for your users without any downtime.",
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-center font-normal text-neutral-300">
          From CMS to AI Agent LLM, to creating Ecommerce Dashboard with AI we've got everything covered.
        </p>
      </div>
